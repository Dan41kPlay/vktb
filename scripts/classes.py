...
@dataclass
class VersionInfo:
    full: str = f'1.0.0indev16.01 (000000.0-1601.{datetime.now():{Constants.DateTimeForms.forVersion}})'
    name: str = 'Release'
    changelog: str = (
        '\n\n❕1.0.0r'
        '➕Initial release'
...
class BenchPressDumbbellsLying(Exercise):
    ...
    animationPath: str = 'exercises\\Bench_press_dumbbells_lying.gif'
...
class BenchPressDumbbellsSitting(Exercise):
    ...
    animationPath: str = 'exercises\\Bench_press_dumbbells_Sitting.gif'
...
class BenchPressLying(Exercise):
    ...
    animationPath: str = 'exercises\\Bench_press_lying.gif'
...
class BendingHandsWithRod(Exercise):
    ...
    animationPath: str = 'exercises\\Bending_hands_with_rod.gif'
...
class BreedingDumbbellsLying(Exercise):
    ...
    animationPath: str = 'exercises\\Breeding_dumbbells_lying.gif'
...
class FightingHandsTilt(Exercise):
    ...
    animationPath: str = 'exercises\\Fighting_hands_Tilt.gif'
...
class FrenchBenchPressLying(Exercise):
    ...
    animationPath: str = 'exercises\\French_bench_press_lying.gif'
...
class Pushups(Exercise):
    ...
    animationPath: str = 'exercises\\Pushups.gif'
...
class SquatsWithRod(Exercise):
    ...
    animationPath: str = 'exercises\\Squats_with_rod.gif'
...
class StanTraction(Exercise):
    ...
    animationPath: str = 'exercises\\Stan_traction.gif'
...
class TractionToBelt(Exercise):
    ...
    animationPath: str = 'exercises\\Traction_to_belt.gif'
